...
CC_IDENT=Apple clang version 12.0.5 (clang-1205.0.22.11)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
CC=gcc
...
EXTRALIBS-avcodec=-liconv -lm -llzma -framework AudioToolbox -pthread -lz -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
EXTRALIBS-swresample=-lm
EXTRALIBS-avutil=-pthread -lm -framework VideoToolbox -L/usr/local/Cellar/libx11/1.8.1/lib -lX11 -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
